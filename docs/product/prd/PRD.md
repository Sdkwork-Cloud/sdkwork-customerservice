...
- `pnpm test:postgres` passes when `SDKWORK_DATABASE_URL` points at a migrated database (11 integration tests: repository persistence + gateway HTTP for app-api, backend-api, and internal ingress auth)
